...
<body>
    <div class="wrapper rounded6" id="templateContainer">
		...
		<div id="templateBody" class="bodyContent rounded6">
			...
			<p>
            	Si por cualquier razón quieres suscribirte nuevamente, haz click en el siguiente link:
				<a href="https://partidodigital.org.uy/afiliaciones">
					<b>Suscribirme nuevamente</b>
				</a>
			</p>
			<p>
				<span class="small">Por cualquier consulta no dudes en escribirnos a
