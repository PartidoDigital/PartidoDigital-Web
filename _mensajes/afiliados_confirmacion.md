    ...
    <div class="wrapper rounded6" id="templateContainer">
        ...
        <div class="wrapper rounded6" id="templateContainer">
            ...
            <div id="templateBody" class="bodyContent rounded6">
                <h2>Un paso más...</h2>
                <div>
                    <p>Para finalizar tu afiliación con el Partido Digital, vas a recibir un correo con los detalles para finalmente concretar tu aporte al Partido Digital.</p>
                    <p>En ese correo se describe los pasos que debes seguir dada tu preferencia seleccionada.</p>
                </div>
