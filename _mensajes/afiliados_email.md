...
<body>
    <div class="wrapper rounded6" id="templateContainer">
		...
		<div id="templateBody" class="bodyContent rounded6">
			<h2>Confirmación</h2>
			<p>
				<a href="https://partidodigital.us14.list-manage.com/subscribe/confirm?u=8e16f7903de2c0600985cf9e2&id=d69798f48c&e=*|UNIQID|*">
					<b>Haga click aquí para confirmar tu correo electrónico</b>
				</a>
			</p>
			...
			<p>
				<span class="small">Por cualquier consulta sobre el proceso de afiliación no dudes en escribirnos a
