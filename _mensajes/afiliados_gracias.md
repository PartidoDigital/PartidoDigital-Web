...
<head>
    ...
    <title>Confirma tu correo - Partido Digital del Uruguay</title>
		...
		<h1 class="masthead"></h1>
      	<div id="templateBody" class="bodyContent rounded6">
			...
			<div>
				...
				<p>Para completar el proceso de afiliación por favor clickea en el link que acabamos de enviarte a tu correo.</p>
			</div>
